...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post concepts_url, params: { concept: { category: @concept.category, title: @concept.title } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { category: @concept.category, title: @concept.title } }
