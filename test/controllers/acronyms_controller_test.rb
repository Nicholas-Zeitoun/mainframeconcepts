...
class AcronymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create acronym" do
    assert_difference('Acronym.count') do
      post acronyms_url, params: { acronym: { content: @acronym.content, title: @acronym.title } }
    end
  ...
  test "should update acronym" do
    patch acronym_url(@acronym), params: { acronym: { content: @acronym.content, title: @acronym.title } }
