...
ActiveRecord::Schema.define(version: 2020_11_02_142919) do
  ...
  create_table "resources", force: :cascade do |t|
    ...
    t.index ["resourcable_type", "resourcable_id"], name: "index_resources_on_resourcable_type_and_resourcable_id"
  end
